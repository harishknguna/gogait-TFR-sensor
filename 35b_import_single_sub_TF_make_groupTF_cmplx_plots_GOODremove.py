...
for ei, evnt in enumerate(event_type):
    ...
    report.title = 'Group sub TF : ' + evnt + '_' + baseline + '_' +  version + '_' + waveType + '_' + numType + '_abs(.)' 
    ...
    report.save(report_fname+'_' + evnt + '_' + baseline + '_' + version+ '_' + waveType + '_' + numType + '_abs.html', overwrite=True)            
